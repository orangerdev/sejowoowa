 ...
 */
class Sejowoowa_User_Request_Fund_Processed {
	...
	public function __construct() {
		...
		$this->option_name 			= 'sejowoowa_user_request_fund_processed_options';
		$this->option_page 			= 'user_request_fund_processed_page';
		$this->section_name 		= 'user_request_fund_processed_section';
		$this->option_group_name 	= 'sejowoowa_user_request_fund_processed_options';
	}
	...
	public function get_option_fields() {
		...
		// Active field
		$fields[] = array(
			'name' 	=> 'user_request_fund_processed_active', 			//Name
		...
		// Message field
		$fields[] = array(
			'name' 	=> 'user_request_fund_processed_message', 			//Name
			'label' => 'Message', 										//Label
	...
	public function set_default_option_fields() {
		...
		$default = array(
        	'user_request_fund_processed_active' 		=> true,
    		'user_request_fund_processed_message' 		=> 'Permintaan pencairan dana anda dari {site_title} ({site_url}) {status}. Detail proses sebagai berikut {detail_request_fund}'
	    );
	...
	public function is_active() {
		...
		$field_name = 'user_request_fund_processed_active';
	...
	public function initialize_options() {
	    ...
	    add_settings_section(
	        ...
	        'Update Proses Permintaan Pencairan Dana',    	// Title to be displayed on the administration page
	...
	public function section_callback() {
		...
		$description = '<p>Notifikasi terkait proses dari pencairan dana, dikirim ke user.</p>';
		echo $description;
	}
	...
	public function send_message( \WP_User $admin, array $request_data ) {
	    ...
	    // Get message content
	    $message_content = $this->get_option_value( 'user_request_fund_processed_message' );
