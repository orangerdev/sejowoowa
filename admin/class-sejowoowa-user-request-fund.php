 ...
 */
class Sejowoowa_User_Request_Fund {
	...
	public function __construct() {
		...
		$this->option_name 			= 'sejowoowa_user_request_fund_options';
		$this->option_page 			= 'user_request_fund_page';
		$this->section_name 		= 'user_request_fund_section';
		$this->option_group_name 	= 'sejowoowa_user_request_fund_options_group';
	}
	...
	public function set_default_option_fields() {
		...
		$default = array(
        	'user_request_fund_active' 		=> true,
    		'user_request_fund_message' 	=> 'Anda baru saja melakukan permintaan pencairan dana dari {site_title} ({site_url}) sebesar {amount} dengan rincian {detail_request_fund}'
	    );
	...
	public function is_active() {
		...
		$field_name = 'user_request_fund_active';
	...
	public function section_callback() {
		...
		$description = '<p>Notifikasi yang terkait pencairan dana, dikirim ke user.</p>';
		echo $description;
	}
	...
	public function send_message( \WC_Customer $user, array $request_data ) {
	    ...
	    // Get message content
	    $message_content = $this->get_option_value( 'user_request_fund_message' );
	    ...
	    $footer_message		= 'Kami mohon waktunya untuk proses pencairan dana. Jika kami sudah memproses pencairan, sistem akan mengirimkan kembali email notifikasi.';
